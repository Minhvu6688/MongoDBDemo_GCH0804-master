...
app.post('/doInsert', async (req, res) => {
    ...
    if (isNaN(priceInput) == true || priceInput == null || priceInput <= 100000) {
        res.render('insert', { priceError: 'Unavailable Price!' })
    }
    else {
...
app.post('/doRegister', async (req, res) => {
    ...
    if (nameInput.indexOf("@") != -1) {
        ...
        res.render('register', { passError: 'Password must have more than five characters!' })
    }
    else {
